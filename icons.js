...
const P = {
  ...
  /* `refresh` ne veut plus dire que « recharger » : bandeau de mise à
     jour, et rien d'autre. Il a longtemps servi AUSSI aux doubles et à
     l'onglet Échange, à côté de `swap` (la réserve) — deux arcs fléchés
     tous les deux. Comparés côte à côte à 12 et 14 px, ce sont le même
     dessin pour l'œil : l'archétype « flèches circulaires » écrase la
     différence de tracé. C'est ce voisinage qui avait déjà laissé passer
     une divergence silencieuse sur le marqueur de tuile (1.55.1).
     Les doubles ont donc leur propre symbole, `copy` — deux rectangles
     identiques décalés, qui disent « plusieurs exemplaires » au lieu de
     « recommencer ». */
  refresh: '<path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/><path d="M8 16H3v5"/>',
  copy: '<rect width="13" height="13" x="8.5" y="8.5" rx="2"/><path d="M4.5 15.5A2 2 0 0 1 2.5 13.5v-9a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2"/>',
  ...
  // layers / award : géométrie IDENTIQUE aux onglets Collection et
  // Badges de la nav du bas — le bandeau de page et l'onglet montrent
  // le même signe, c'est ce qui fait le repérage.
