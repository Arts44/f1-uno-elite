...
| Tests | **Nodes eingebauter Test-Runner** (`node --test`) — 905 Tests, kein Test-Framework |
...
**Lösung:** Die Logik wurde browserfrei faktorisiert und wird von **905 Tests auf Nodes eingebautem Runner** abgedeckt — keine Testabhängigkeiten, kein echtes Netzwerk. Die CI baut zudem das Bundle neu und schlägt fehl, wenn das committete Artefakt veraltet ist.

---

### Was die Tests abdecken — und was nicht

905 Tests auf Nodes eingebautem Runner, ohne Framework. Genauigkeit über die Grenze zählt mehr als die Zahl:
...
npm test        # 905 Tests, node --test, ohne Framework
```
