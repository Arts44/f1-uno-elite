...
const SHELL_ASSETS = [
  ...
  'changelog.js',
  'secure-store.js',
  'feedback.js', 'review-invite.js', 'storage-keys.js', 'badges-store.js', 'season.js', 'badge-cards.js', 'badge-titles.js', 'badge-rules.js', 'badge-toasts.js', 'profile-card.js', 'share-file.js', 'journal.js', 'trade-inbox.js', 'moment.js', 'tutorial-snapshot.js',
  'otp-input.js',
  'session.js',
  'account.js',
  'icons.js',
  ...
  // Une entree par saison LIVREE de metadata.json (seasons[]).
  // Les saisons marquees test: true en sont exclues : elles ne servent
  // qu a l entree de developpement et n ont pas a etre mises en cache
  // hors ligne pour un visiteur. tests/precache.test.js verifie les deux
  // sens — livree donc presente, test donc absente.
