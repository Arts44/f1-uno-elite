...
| 永恒稀有度——全套冠军卡 | 快速添加——版本选择器 |
|---|---|
| ![永恒稀有度——全套冠军卡](screenshots/i18n/eternal-tile.zh.jpg) | ![快速添加——版本选择器](screenshots/i18n/quick-add.zh.jpg) |

| 含永恒的稀有度圆环 | 撤销提示 |
|---|---|
| ![含永恒的稀有度圆环](screenshots/i18n/stats-rarity.zh.jpg) | ![撤销提示](screenshots/i18n/toast.zh.jpg) |
...
- 🎓 **22 步交互式教程** — 一次引导式导览，让你*亲手执行*真实操作；教程运行在沙盒中，结束时会撤销所有改动。
